...
function aboutNavGraph( n) {

	console.log('graph d', n);
	var gTime = n;
	var LineGraph = [];
	var LineGraphTime = [];

	$.ajax({
		url: MktAPI + 'GetBars?mCode=TechnoSavvyusdt&pulse=' + gTime + '&count=24',
		method: "GET",
		headers: {
