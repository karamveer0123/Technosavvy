...
// ],
// "studies_overrides": {
//            "moving average exponential.length":0
//        },
//// "watchlist": [
////    "BINANCE:BTCUSDT"
////  ],
...
;(function ($, window) {
  ...
  var tabUtils = function () {
    ...
    function getIndexOfClosestEnabledTab($currTabLis, startIndex) {
      ...
      while (closestIdx === -1 && testIdx >= 0) {if (window.CP.shouldStopExecution(0)) break;
  ...
  function destroyPlugin() {
    ...
    while (--$.fn.scrollingTabs.nextInstanceId >= 0) {if (window.CP.shouldStopExecution(1)) break;
