...
function changetrdTabAdv() {
	$(".red.formtab").addClass("active-a9");
	$(".green.formtab").removeClass("active-a9");
	$("#tabredAdv").addClass("tab-active9");
	$("#tabGreenAdv").removeClass("tab-active9");
}
function changetab() {
	$(".red.formtab").removeClass("active-a9");
	$(".green.formtab").addClass("active-a9");
	$("#tabredAdv").removeClass("tab-active9");
	$("#tabGreenAdv").addClass("tab-active9");
}
...
function changetrdTab18() {
	...
	$(".red").addClass("active-a9");
	$(".green").removeClass("active-a9");
	$("#tabred-8").addClass("tab-active9");
	$("#tabGreen-8").removeClass("tab-active9");
}
...
function changetrdTab20() {

	$(".red").addClass("active-a9");
	$(".green").removeClass("active-a9");
	$("#tabred-02").addClass("tab-active9");
	$("#tabGreen-02").removeClass("tab-active9");
}
function changetab20() {
	$(".red").removeClass("active-a9");
	$(".green").addClass("active-a9");
	$("#tabred-02").removeClass("tab-active9");
	$("#tabGreen-02").addClass("tab-active9");
}
...
function changeAdvTrade() {
	$(".green.myTrade").addClass("active-a9");
	$(".red.myTrade").removeClass("active-a9");
	$("#tabred").removeClass("tab-active9");
	$("#tabGreen").addClass("tab-active9");
}
function changeAdvMyTrade() {
	$(".red.myTrade").addClass("active-a9");
	$(".green.myTrade").removeClass("active-a9");
