(function ($) {
		...
		*/
		...
		return this.each(function () {
			...
			function refresh_first(page_number) {
				...
				*/
				var first_html = '<' + settings.navigation_element + ' href="javascript:void(0)" class="' + settings.html_prefix + '-navigation-first';
			...
			function refresh_previous(page_number) {
				var previous_page = page_number > 1 ? page_number - 1 : 1,
					previous_html = '<' + settings.navigation_element + ' href="javascript:void(0)" class="' + settings.html_prefix + '-navigation-previous';
			...
			function refresh_next(page_number) {
				var next_page = page_number + 1 > page_count ? page_count : page_number + 1,
					next_html = '<' + settings.navigation_element + ' href="javascript:void(0)" class="' + settings.html_prefix + '-navigation-next';
			...
			function refresh_last(page_number) {
				var last_html = '<' + settings.navigation_element + ' href="javascript:void(0)" class="' + settings.html_prefix + '-navigation-last';
			...
			function refresh_page_numbers(page_number) {
				...
				var half_of_number_of_page_numbers_visable = Math.ceil(number_of_visible_page_numbers / 2) - 1,
					...
					create_page_navigation = function () {
						page_number_html = '<' + settings.navigation_element + ' href="javascript:void(0)" class="' + settings.html_prefix + '-navigation-page';
	...
	$.fn.simplePagination.defaults = {
		...
		//
		first_content: '<i class="fa fa-angle-double-left" aria-hidden="true"></i>',  //e.g. '<<'
		previous_content: '<i class="fa fa-angle-left" aria-hidden="true"></i>',  //e.g. '<'
		next_content: '<i class="fa fa-angle-right" aria-hidden="true"></i>',  //e.g. '>'
		last_content: '<i class="fa fa-angle-double-right" aria-hidden="true"></i>', //e.g. '>>'
