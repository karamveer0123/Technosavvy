	...
	if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
			...
			l = {
				...
				widget: function(e) {
					...
					this.options = {
						...
						publish_source: e.publish_source || "false",
		...
		l.WidgetAbstract.prototype = {
			...
			addWrapperFrame: function(e, t, o) {
				...
				o = o || "transparent";
				return '<div id="' + this.id + '-wrapper" style=" ' + n + ";height: " + i + ";margin: 0 auto !important;padding: 0 !important;font-family: " + d + ';"><div style="width: ' + n + ";height: " + i + ";background: " + o + ';padding: 0 !important;">' + e + "</div>" + (t || "") + "</div>"
			},
//			addFooterLogo: function(e, t) {
//				var o = (t || {}).greyText || "",
//					i = (t || {}).linkText || "",
//					n = (t || {}).href || "";
//				return l.WidgetAbstract.prototype.addWrapperFrame.call(this, e, '<div style="position:absolute;display: block;box-sizing: content-box;height: 24px;width: ' + l.WidgetAbstract.prototype.width.call(this) + ";bottom: 0;left: 0;margin: 0;padding: 0;font-family: " + d + ';"><div><a href="' + n + "?" + l.generateUtmForUrlParams(this.options) + '" target="_blank" style="color: #0099d4;text-decoration: none;font-size: 11px;"><span style="color: #b4b4b4;font-size: 11px;">' + o + "</span> " + i + "</a></div></div>", "#fff")
//			}
			...
			widgetCode: function() {
				...
				for (var s = ["gridLineColor", "fontColor", "underLineColor", "underLineBottomColor", "trendLineColor", "activeTickerBackgroundColor", "timeAxisBackgroundColor", "locale", "scalePosition", "scaleMode", "chartType", "color", "lineColor", "topColor", "bottomColor", "upColor", "downColor", "borderUpColor", "borderDownColor", "wickUpColor", "wickDownColor", "fontFamily", "noTimeScale", "valuesTracking", "lineWidth", "volumeUpColor", "volumeDownColor"], a = "", d = s.length - 1; d >= 0; d--) {
					var h = s[d],
						c = this.options[h];
			...
			create: function() {
				...
				l.chartCssAttached || (l.css(this.renderCss()), l.chartCssAttached = !0), h(t, this.options.container), e = document.getElementById(this.id), l.bindEvent(e, "load", (function() {
					...
					var t = !1;
					if (document.querySelector && document.querySelector('a[href$="/#/' + o.options.chart + '/"]') && (t = !0), !t)
