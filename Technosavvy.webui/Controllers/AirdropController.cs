...
[Route("Airdrop-program")]
[Route("Airdropprogram")]
[DenyAccessInPreBeta]
...
public class AirdropController : Controller
{
    ...
    public AirdropController(ILogger<HomeController> logger, IOptions<SmtpConfig> smtp, IConfiguration configuration, IHttpContextAccessor accessor, IDataProtectionProvider provider, ITempDataDictionaryFactory tddf)
    {
        _logger = logger;
        _smtp = smtp;
