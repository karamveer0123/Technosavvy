namespace TechnoApp.Ext.Web.UI.Model
{
    public class mToken
    {
        ...
        //We may not use these Numbers in case of TechnoApp only information is to displayed
    ...
    public class mNetAddr
    {
        public string Address { get; set; }
        public string Network { get; set; }
        public string Name { get; set; }
    }
    public class mToken3
    {
        public mToken token { get; set; }
        public string Symbole { get; set; }//₹ $
    }
    public class mToken2
    {
        public mToken token { get; set; }
    ...
    public class mUPIPaymentMethod 
    {
    ...
    public class mBankDepositPaymentMethod 
    {
        public Guid ID { get; set; }
